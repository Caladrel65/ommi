<div class="container">
  ...
  <!-- Make this spread across the whole scren? Also, give faint/calm green background? -->
   <!-- The goal is to make it bigger than the rest of the page to show importance. -->
  <section>
  ...
  <!-- More casual look here is to not force justify or whatever so the edges aren't the same. Let the text fluctuate a little. -->
  <section>
  ...
  <!-- This one has a green background again. -->
   <section>
